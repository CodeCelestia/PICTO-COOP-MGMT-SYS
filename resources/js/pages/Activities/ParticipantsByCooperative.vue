...
const breadcrumbs = computed<BreadcrumbItem[]>(() => [
    ...
    { title: props.cooperative.name, href: `/activities/${props.activity.id}/cooperatives/${props.cooperative.id}/participants` },
    { title: 'Participants', href: `/activities/${props.activity.id}/cooperatives/${props.cooperative.id}/participants` },
]);
...
const participantStatus = (participant: Participant) => {
    return participant.is_beneficiary ? 'Beneficiary' : 'Registered';
};
...
const participantRole = (participant: Participant) => {
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div class="space-y-1">
                        <h1 class="text-2xl font-semibold tracking-tight text-foreground sm:text-3xl">
                            Participants from {{ cooperative.name }} in {{ activity.title }}
                        </h1>
                        <p class="text-sm text-muted-foreground">
                            View member participants from the selected cooperative for this activity.
                        </p>
                    </div>
                    <Link :href="`/activities/${activity.id}/cooperatives-participating`">
                    ...
                    <Table>
                        ...
                        <TableBody>
                            ...
                            <TableRow v-for="participant in participants" :key="participant.id">
                                ...
                                <TableCell class="text-muted-foreground">{{ participantRole(participant) }}</TableCell>
