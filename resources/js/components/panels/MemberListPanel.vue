                        ...
                        <TableRow v-for="member in members.data" :key="member.id">
                            ...
                            <TableCell v-if="showActions" class="text-center">
                                <div class="flex flex-wrap justify-center gap-2">
                                    ...
                                    <Link v-if="canReadMemberLoans" :href="cooperativeId ? `/cooperatives/${cooperativeId}/finance/loans/create?member_id=${member.id}&return_to=members` : `/finance/loans/create?member_id=${member.id}`">
                                        <Button
                                            variant="outline"
                                            size="sm"
