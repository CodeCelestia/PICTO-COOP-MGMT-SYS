...
const form = useForm({
    ...
    date_granted: props.support.date_granted || '',
    date_completed: props.support.date_completed || '',
...
const submit = () => {
    ...
    })).put(`/external-supports/${props.support.id}`, {
        preserveScroll: true,
    });
};
...
<template>
    <AppLayout>
        <div class="p-6">
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-900">Edit External Support</h1>
                <p class="mt-1 text-sm text-gray-500">Update external support details.</p>
            </div>
