...
<template>
    <AppLayout>
        <div class="space-y-6 p-4 sm:p-6">
            <div class="space-y-1">
                <h1 class="text-2xl font-semibold tracking-tight text-foreground sm:text-3xl">Edit Training Participant</h1>
                <p class="text-sm text-muted-foreground">Update participant details for a training session.</p>
            </div>
