...
import { ArrowLeft, GraduationCap, Lock, Save, X, Search } from 'lucide-vue-next';
                                ...
                                <table class="min-w-full divide-y divide-border text-left text-sm">
                                    ...
                                    <tbody class="divide-y divide-border bg-card">
                                        <tr v-if="filteredMembers.length === 0">
                                            <td :colspan="5" class="px-3 py-4 text-center text-sm text-muted-foreground">No members found for the selected cooperative(s).</td>
                                        </tr>
