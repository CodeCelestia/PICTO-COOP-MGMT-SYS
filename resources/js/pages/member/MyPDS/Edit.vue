            ...
            <div class="rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-5 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-xl font-bold">Edit My Personal Data Sheet</h1>
                            <p class="text-sm text-blue-100">{{ pds.last_name }}, {{ pds.first_name }}</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
                        <Link href="/member/my-pds"><Button variant="ghost" class="border border-white/30 text-white hover:bg-white/20 gap-2"><ArrowLeft class="h-4 w-4" /> View</Button></Link>
            ...
            <form @submit.prevent="submit">
                <div class="rounded-xl border border-slate-200 bg-white shadow-sm p-6 space-y-6">
                    ...
                    <div v-show="activeTab === 0" class="space-y-6">
                        <p class="text-xs font-bold uppercase tracking-wider text-indigo-600">I. Personal Information</p>
                        ...
                        <p class="text-xs font-bold uppercase tracking-wider text-indigo-600 pt-2">Government IDs</p>
                        ...
                        <p class="text-xs font-bold uppercase tracking-wider text-indigo-600 pt-2">Contact Information</p>
                        ...
                        <p class="text-xs font-bold uppercase tracking-wider text-indigo-600 pt-2">Residential Address</p>
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div v-if="!form.perm_same_as_res" class="space-y-4">
                            <p class="text-xs font-bold uppercase tracking-wider text-indigo-600 pt-1">Permanent Address</p>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div v-show="activeTab === 1" class="space-y-6">
                        <p class="text-xs font-bold uppercase tracking-wider text-indigo-600">II. Family Background</p>
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-3">
                                <p class="text-xs font-bold uppercase tracking-wider text-indigo-600">Children</p>
                    ...
                    <div v-show="activeTab === 2" class="space-y-4">
                        <p class="text-xs font-bold uppercase tracking-wider text-indigo-600">III. Educational Background</p>
                    ...
                    <div v-show="activeTab === 3" class="space-y-4">
                        <div class="flex items-center justify-between">
                            <p class="text-xs font-bold uppercase tracking-wider text-indigo-600">IV. Civil Service Eligibility</p>
                            <Button type="button" variant="outline" size="sm"
                    ...
                    <div v-show="activeTab === 4" class="space-y-4">
                        <div class="flex items-center justify-between">
                            <p class="text-xs font-bold uppercase tracking-wider text-indigo-600">V. Work Experience</p>
                            <Button type="button" variant="outline" size="sm"
                    ...
                    <div v-show="activeTab === 5" class="space-y-6">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-3">
                                <p class="text-xs font-bold uppercase tracking-wider text-indigo-600">VI.A. Voluntary Work</p>
                                <Button type="button" variant="outline" size="sm"
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-3">
                                <p class="text-xs font-bold uppercase tracking-wider text-indigo-600">VI.B. Learning &amp; Development Interventions</p>
                                <Button type="button" variant="outline" size="sm"
                    ...
                    <div v-show="activeTab === 6" class="space-y-6">
                        <p class="text-xs font-bold uppercase tracking-wider text-indigo-600">VII. Other Information</p>
                        ...
                        <p class="text-xs font-bold uppercase tracking-wider text-indigo-600 pt-2">Questions</p>
                        <div class="space-y-3">
                    ...
                    <div v-show="activeTab === 7" class="space-y-6">
                        <p class="text-xs font-bold uppercase tracking-wider text-indigo-600">VIII. Character References (not relatives, not former supervisors)</p>
                        <div class="space-y-3">
                        ...
                        <p class="text-xs font-bold uppercase tracking-wider text-indigo-600 pt-2">Government-Issued ID</p>
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
