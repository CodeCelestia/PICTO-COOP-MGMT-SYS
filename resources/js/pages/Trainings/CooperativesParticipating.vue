                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div class="space-y-1">
                        <h1 class="text-2xl font-semibold tracking-tight text-foreground sm:text-3xl">
                            Cooperatives Participating in {{ training.title }}
                        </h1>
                        <p class="text-sm text-muted-foreground">
                            Review cooperatives involved in this training and drill down to member participants.
                        </p>
                    </div>
                    <Link href="/trainings">
                        ...
                        <TableBody>
                            ...
                            <TableRow v-for="cooperative in cooperatives" :key="cooperative.id">
                                ...
                                <TableCell class="text-center">
                                    <Link :href="`/trainings/${training.id}/cooperatives/${cooperative.id}/participants`">
